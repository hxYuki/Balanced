  ...
  render() {
    return (
      ...
      >
        ...
        {this.state.ShowPageFlag === 'Statistics' && <Statistics db={this.props.db} openDrawerCB={() => { this.openDrawer() }} />}
        {this.state.ShowPageFlag === 'Cycles' && <Cycles db={this.props.db} openDrawerCB={() => { this.openDrawer() }} />}
      </DrawerLayoutAndroid>
    );
  }
}
